    ...
    <div className=" mt-32 lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      ...
      <div className="w-[80%] mx-auto">
        <div className="text-center max-w-2xl mx-auto tracking-normal leading-5 text-base sm:text-[1.1rem] lg:text-lg">
          During these {new Date().getUTCFullYear() - 2021} years of experience in Full-Stack Development, I have honed strong problem-solving and critical thinking skills. I have quickly adapted to new technologies and methods of working. Below is a skill set that I have mastered and continue to actively learn:
        </div>
      ...
      <div className="flex flex-col relative space-y-16 md:space-y-10 lg:space-y-8 items-center">
        <div className="drop-shadow-2xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl">
          ...
          <div className="font-normal sm:text-[0.95rem] md:text-base text-center">
            Specialized in creating beautiful and user-friendly websites with my skills mainly in ReactJs-centered tools. In addition to frontend development, I have extensive experience in backend development using Node.js and Express and Golang backend. I ensure seamless integration, efficient deployment, and add a splash of personality to every project I work on.
          </div>
        </div>
        <div className="drop-shadow-xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl rounded-[1.4rem] p-4 rounded-tl-none">
          ...
          <div className="font-normal sm:text-[0.95rem] md:text-base text-center">
            With a blend of technical expertise and operational efficiency, DevOps transforms software development into a seamless and automated process. It ensures reliability, scalability, and rapid deployment, empowering teams to deliver value consistently.
          </div>
        </div>

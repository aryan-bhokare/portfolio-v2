...
const tech = () => {
  const data = [
    ...
    },
    {
      ...
      desc: "A platform that enables developers to build, deploy, and manage applications in isolated, portable containers.",
      tag: "platform",
      bg: "bg-orange-500",
    ...
    },
    {
      title: "Kubernetes",
      id: 12,
      main: "/icons/kubernetes.svg",
      desc: "Kubernetes is an open-source platform for automating the deployment, scaling, and management of containerized applications",
      tag: "platform",
      bg: "bg-orange-500",
      text: "text-orange-100",
    }, {
      title: "Golang",
      id: 13,
      main: "/icons/golang.svg",
      desc: "Go, also known as Golang, is a statically typed, compiled programming language designed for simplicity, efficiency, and reliability in building scalable and high-performance applications.",
      tag: "platform",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
